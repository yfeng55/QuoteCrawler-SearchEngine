...
public class WebCrawler {
    ...
    private void initialize() throws MalformedURLException {
        ...
        if(url_input.equals("")){
            ...
            try {
//                starting_urls.add(new URL("http://www.wsj.com/news/world"));
                starting_urls.add(new URL("http://www.bloomberg.com/politics"));
//                starting_urls.add(new URL("http://www.nytimes.com"));
//                starting_urls.add(new URL("http://www.mercurynews.com"));
//                starting_urls.add(new URL("http://www.usatoday.com"));
//                starting_urls.add(new URL("http://www.latimes.com"));
